        ...
        <div className='mx-auto max-w-7xl px-6 lg:px-8'>
          ...
          >
            <div className='flex flex-col justify-center rounded-3xl bg-white p-8 ring-1 ring-gray-200 xl:p-10 lg:z-10 lg:rounded-b-none'>
              ...
              <button
                onClick={goToTop}
                className={`mt-8 block rounded-md py-2 px-3 text-center text-sm font-semibold leading-6 shadow-sm text-white focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 ${
                  clicked ? 'bg-red-600' : 'bg-indigo-600'
                } hover:bg-indigo-500`}
              >
                Satın alma planı
              </button>
